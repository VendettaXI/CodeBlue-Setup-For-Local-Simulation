...
export default function TopTabSwitcher({ activeTab, onTabChange }) {
  ...
  const segmentWidth = 104; // smaller than before
      ...
      >
        ...
        <div
          ...
          style={{
            ...
            background: `linear-gradient(135deg, ${COLORS.gunmetalActive}, ${COLORS.gunmetalActive})`,
            transform: `translateX(${sliderPos * segmentWidth}px)`,
            boxShadow: `0 0 0 1px rgba(249,115,143,0.22), 0 6px 18px rgba(15,33,58,0.35)`,
          }}
        />
